...
public class GraphSearch
{
    ...
    {
        Dictionary<Vector3Int, Vector3Int?> visitedNoteds = new Dictionary<Vector3Int, Vector3Int?>();
        ...
        visitedNoteds.Add(startPoint, null);
        ...
        while (nodesToVisitQueue.Count > 0)
        {
            ...
            foreach(Vector3Int neighbourPosition in hexGrid.GetNeighboursFor(currentNode))
            {
                ...
                {
                    if (!visitedNoteds.ContainsKey(neighbourPosition))
                    {
                        visitedNoteds[neighbourPosition] = currentNode;
        ...
        return new BFSResult { visitedNodesDict = visitedNoteds };
    }
